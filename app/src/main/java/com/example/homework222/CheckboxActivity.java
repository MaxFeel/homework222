...
public class CheckboxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mutually_exclusive_checkbox);
        initViews();
    ...
    private final View.OnClickListener okListner = new View.OnClickListener(){
        ...
        public void onClick(View v) {
            if(mBankCardChkBx.isChecked()){
                okText = "Оплата по баноковской карте: "+ mInputInfo.getText() + " на сумму "+
                        mInputMoney.getText();;
            }
            else if(mMobilePhoneChkBx.isChecked()){
                okText = "Оплата с мобильного телефона: "+ mInputInfo.getText() + " на сумму "+
                        mInputMoney.getText();
            }
            else if(mCashAddressChkBx.isChecked()){
                okText = "Оплата наличкой по адресу: "+ mInputInfo.getText() + " на сумму "+
                        mInputMoney.getText();
            }
            Toast.makeText(CheckboxActivity.this, okText, Toast.LENGTH_LONG).show();
        }
    };
}
